...
\section{Awards}
\cvitemwithcomment{}{\textbf{2024 ICBS Frontiers of Science Award in Theoretical Physics}}{2024}
\begin{tabular}{rcl}
&\hspace{0.4cm} &{\color{color1} $\circ\;\;$}\emph{Awarded by:} The International Congress of Basic Science \\
&\hspace{0.4cm} &{\color{color1} $\circ\;\;$}\emph{Awarded for:} ``Reporting first evidence for the existence of a gravitational wave\\
...
\cvitemwithcomment{}{\hspace{0.15cm}${\color{color1} \circ}\;$ \textit{\textbf{Co-chair}}, NANOGrav Detection Working Group}{April 2024--Present} \vspace{-0.1cm}

\cvitemwithcomment{}{\hspace{0.15cm}${\color{color1} \circ}\;$ \textit{\textbf{Lead}}, NANOGrav 15-year Detector Characterization Analysis}{Mar 2021--June 2023} \vspace{-0.1cm}
...
\cvitemwithcomment{}{\hspace{0.4cm}${\color{color1} \circ}\;$ {\color{color1} \href{https://astronomyontap.org/event/astronomy-on-tap-corvallis-astrobiology/}{\textit{Organizing Corvallis Astronomy on Tap Lecture Series}}}}{Fall 2023 -- Present} \vspace{-0.1cm}
